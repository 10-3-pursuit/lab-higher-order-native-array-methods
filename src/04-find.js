...
function findPinkElephantsByTimestreet(songs) {
  const pnkele = songs.find((song) => song.title === "Pink Elephants")
  return pnkele;
}
...
function findFirstTitleTrack(songs) {
  const firstSongwithSameSameName = songs.find((song) => song.title === song.album)
  return firstSongwithSameSameName;
}
