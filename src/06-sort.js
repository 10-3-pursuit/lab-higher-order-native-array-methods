...
function sortByRuntimeAscending(songs) {
  const shortestRunTimeFirst = songs.sort((a, b) => {
...
function sortByArtistNameDescending(songs) {
  ...
  return sortByArtistNameDescending;
}
...
function sortBySongTitleAscending(songs) {
  const sortBySongTitleAscending = songs.sort((a, b) => {
  ...
  return sortBySongTitleAscending;
}
